...
namespace Nop.Plugin.Payments.CheckMoneyOrder
{
    ...
    public class CheckMoneyOrderPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public override void Install()
        {
            ...
            {
                DescriptionText = "<p><br /><b>This is being submitted for an estimate only and an official quote will be provided by the rental department shortly by email</b> <br />"
            };
